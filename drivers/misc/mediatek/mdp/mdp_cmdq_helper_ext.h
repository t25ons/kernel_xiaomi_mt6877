...
#define CMDQ_TRACE_FORCE_COUNTER(fmt, count, args...) ((void)0)
#define CMDQ_SYSTRACE_BEGIN(fmt, args...) ((void)0)
#define CMDQ_SYSTRACE_END() ((void)0)
#define CMDQ_SYSTRACE2_BEGIN(fmt, args...) ((void)0)
#define CMDQ_SYSTRACE2_END() ((void)0)
#define CMDQ_SYSTRACE2_COUNTER(fmt, count, args...) ((void)0)
